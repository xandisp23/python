...
0.	Código da cidade;
1.	Número de veículos de passeio (em 1999);
2.	Número de acidentes de trânsito com vítimas (em 1999). Deseja-se saber:
3.	Qual o maior e menor índice de acidentes de transito e a que cidade pertence;
4.	Qual a média de veículos nas cinco cidades juntas;
5.	Qual a média de acidentes de trânsito nas cidades com menos de 2.000 veículos de passeio.
'''
